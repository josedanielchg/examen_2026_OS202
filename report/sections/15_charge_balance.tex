...
\begin{figure}[H]
    \centering
    \input{../plots/stage3_breakdown_plot.tex}
...
Cette solution améliorerait l'équilibre de charge, mais elle introduirait un nouveau coût :
\begin{itemize}
...
Autrement dit, l'étape 3 valide bien la décomposition de domaine et les cellules fantômes, mais elle montre aussi pourquoi une grille régulière ne suffit pas à obtenir une bonne scalabilité sur une galaxie très concentrée.
